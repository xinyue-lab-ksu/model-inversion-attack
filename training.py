...
def train(DATASET = 'CIFAR10', network = 'CIFAR10CNN', NEpochs = 200, imageWidth = 32,
    ...
    if DATASET == 'MNIST':
        ...
        trainset = torchvision.datasets.CIFAR10(root='./data/CIFAR10', train = True, download=True, transform = tsf['train'])
        testset = torchvision.datasets.CIFAR10(root='./data/CIFAR10', train = False, download=True, transform = tsf['test'])
